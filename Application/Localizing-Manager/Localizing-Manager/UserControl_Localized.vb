...
Public Class UserControl_Localized
    ...
    Public Event changed_Text(ByVal objSemItem_Related As clsSemItem)
    ...
    Private Sub fill_LocalizedNames()
        ...
        If Not objSemItem_Related Is Nothing Then
            If Not objSemItems_Languages Is Nothing Then
                objTreeNode_LocalizedNamesRoot = TreeView_Description.Nodes.Add(objLocalConfig_Localize.SemItem_Type_Localized_Names.GUID.ToString, objLocalConfig_Localize.SemItem_Type_Localized_Names.Name, cint_ImageID_LocalizedNames_Root, cint_ImageID_LocalizedNames_Root)

                funcA_Alternative_LocalizedNames.Fill_By_GUIDRef(funcT_Alternative_LocalizedNames, _
                                                      objLocalConfig_Localize.SemItem_Type_Localized_Names.GUID, _
                                                      objLocalConfig_Localize.SemItem_Type_Language.GUID, _
                                                      objLocalConfig_Localize.SemItem_RelationType_alternative_for.GUID, _
                                                      objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID, _
        ...
        If Not objSemItem_Related Is Nothing Then
            ...
            If Not objSemItems_Languages Is Nothing Then
                funcA_Describing_LocalizedDescription.Fill_By_GUID_Token(funcT_Describing_LocalizedDescription, _
                                                                         objLocalConfig_Localize.SemItem_Attribute_Message.GUID, _
                                                                         objLocalConfig_Localize.SemItem_type_LocalizedDescription.GUID, _
                                                                         objLocalConfig_Localize.SemItem_Type_Language.GUID, _
                                                                         objLocalConfig_Localize.SemItem_RelationType_describes.GUID, _
                                                                         objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID, _
                                                                         objSemItem_Related.GUID)
                For Each objSemItem_Language In objSemItems_Languages
                    If objSemItem_Language.Mark = True Then
                        boolStandard = True
                        objTreeNodes = TreeView_Description.Nodes.Find(objLocalConfig_Localize.SemItem_RelationType_Standard.GUID.ToString, False)
                        If objTreeNodes.Length = 0 Then
                            objTreeNode_Parent = TreeView_Description.Nodes.Add(objLocalConfig_Localize.SemItem_RelationType_Standard.GUID.ToString, objLocalConfig_Localize.SemItem_RelationType_Standard.Name, cint_ImageID_Language_Standard, cint_ImageID_Language_Standard)
                        Else
                    ...
                    Else
                        boolStandard = False
                        objTreeNodes = TreeView_Description.Nodes.Find(objLocalConfig_Localize.SemItem_RelationType_additional.GUID.ToString, False)
                        If objTreeNodes.Length = 0 Then
                            objTreeNode_Parent = TreeView_Description.Nodes.Add(objLocalConfig_Localize.SemItem_RelationType_additional.GUID.ToString, objLocalConfig_Localize.SemItem_RelationType_additional.Name, cint_ImageID_Language, cint_ImageID_Language)
                        Else
                            objTreeNode_Parent = objTreeNodes(0)
                        End If
    ...
    Public Sub New(ByVal objGlobals As clsGlobals)
        ...
        objLocalConfig_Localize = New clsLocalConfig(objGlobals)
        ' Fügen Sie Initialisierungen nach dem InitializeComponent()-Aufruf hinzu.
        set_DBConnection()
    End Sub

    Private Sub set_DBConnection()
        semprocA_DBWork_Save_Token.Connection = objLocalConfig_Localize.Connection_DB
        semprocA_DBWork_Del_Token.Connection = objLocalConfig_Localize.Connection_DB
        funcA_Describing_LocalizedDescription.Connection = objLocalConfig_Localize.Connection_Plugin
        funcA_Alternative_LocalizedNames.Connection = objLocalConfig_Localize.Connection_Plugin

        semprocA_DBWork_Save_TokenRel.Connection = objLocalConfig_Localize.Connection_DB
        semprocA_DBWork_Del_TokenRel.Connection = objLocalConfig_Localize.Connection_DB
        semprocA_DBWork_Save_Token_Attribute_VARCHARMAX.Connection = objLocalConfig_Localize.Connection_DB
        procA_DBWork_Save_OR_Token.Connection = objLocalConfig_Localize.Connection_DB

        semprocA_DBWork_Save_Token_OR.Connection = objLocalConfig_Localize.Connection_DB
    End Sub
        ...
        If Not objTreeNode_SelectedLanguage Is Nothing Then
            Select Case objTreeNode_SelectedLanguage.ImageIndex
                Case cint_ImageID_Language_Standard_ToDo, cint_ImageID_Language_Standard_Done, cint_ImageID_Language_ToDo, cint_ImageID_Language_Done
                    ...
                    objSemItem_SelectedDescription.GUID_Type = objLocalConfig_Localize.Globals.ObjectReferenceType_Token.GUID
    ...
    Private Sub Timer_Description_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_Description.Tick
        ...
        If Not strMessage_New = strMessage Then
            If objSemItem_SelectedDescription.new_Item = True Then
                ...
                objSemItem_LocalizedDescription_New.GUID_Parent = objLocalConfig_Localize.SemItem_type_LocalizedDescription.GUID
                ...
                If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                    objDRC_LogState = semprocA_DBWork_Save_TokenRel.GetData(objSemItem_LocalizedDescription_New.GUID, objSemItem_SelectedDescription.GUID_Related, objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID, 0).Rows
                    If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                        'Object-Reference
                        'objDRC_LogState = semprocA_DBWork_Save_TokenRel.GetData(objSemItem_Related.GUID, objSemItem_LocalizedDescription_New.GUID, objLocalConfig_Localize.SemItem_RelationType_isDescribedBy.GUID, 0).Rows
                        objDRC_LogState = procA_DBWork_Save_OR_Token.GetData(objSemItem_Related.GUID).Rows
                        If Not objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Error.GUID Then
                            GUID_ObjectReference = objDRC_LogState(0).Item("GUID_ObjectReference")
                            objDRC_LogState = semprocA_DBWork_Save_Token_OR.GetData(objSemItem_LocalizedDescription_New.GUID, GUID_ObjectReference, objLocalConfig_Localize.SemItem_RelationType_describes.GUID, 0).Rows

                            If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                                objDRC_LogState = semprocA_DBWork_Save_Token_Attribute_VARCHARMAX.GetData(objSemItem_LocalizedDescription_New.GUID, objLocalConfig_Localize.SemItem_Attribute_Message.GUID, Nothing, strMessage_New, 0).Rows
                                If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                                    ...
                                    funcA_Describing_LocalizedDescription.Fill_By_GUID_Token(funcT_Describing_LocalizedDescription, _
                                                          ...
                                                          objLocalConfig_Localize.SemItem_type_LocalizedDescription.GUID, _
                                                          objLocalConfig_Localize.SemItem_Type_Language.GUID, _
                                                          objLocalConfig_Localize.SemItem_RelationType_isDescribedBy.GUID, _
                                                          objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID, _
                                                          objSemItem_Related.GUID)
                                    RaiseEvent changed_Text(objSemItem_Related)
                                Else

                                    semprocA_DBWork_Del_TokenRel.GetData(objSemItem_Related.GUID, objSemItem_LocalizedDescription_New.GUID, objLocalConfig_Localize.SemItem_RelationType_isDescribedBy.GUID)
                                    semprocA_DBWork_Del_TokenRel.GetData(objSemItem_LocalizedDescription_New.GUID, objSemItem_Related.GUID_Related, objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID)
            ...
            Else
                objDRC_LogState = semprocA_DBWork_Save_Token_Attribute_VARCHARMAX.GetData(objSemItem_LocalizedDescription_New.GUID, objLocalConfig_Localize.SemItem_Attribute_Message.GUID, objSemItem_SelectedDescription.GUID_Relation, strMessage_New, 0).Rows
                If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Error.GUID Then
                    MsgBox("Die Beschreibung konnte nicht gespeichert werden!", MsgBoxStyle.Exclamation)
                    clear_LanguageTree()
                End If
            End If
    ...
    Private Sub Timer_Name_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer_Name.Tick
        ...
        If Not objTreeNode Is Nothing Then
            If objTreeNode.ImageIndex = cint_ImageID_LocalizedName Then
                objDLG_Attribute_VARCHAR255 = New dlgAttribute_Varchar255(objTreeNode.Parent.Text, objLocalConfig_Localize.Globals, objTreeNode.Text)
                objDLG_Attribute_VARCHAR255.ShowDialog(Me)
                If objDLG_Attribute_VARCHAR255.DialogResult = DialogResult.OK Then
                    objDRC_LogState = semprocA_DBWork_Save_Token.GetData(New Guid(objTreeNode.Name), objDLG_Attribute_VARCHAR255.Value1, objLocalConfig_Localize.SemItem_Type_Localized_Names.GUID, True).Rows
                    If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Update.GUID Then
        ...
        If Not objTreeNode Is Nothing Then
            If objTreeNode.ImageIndex = cint_ImageID_LocalizedNames_ToDo Then
                ...
                If objDRs_LocalizedNames.Length = 0 Then
                    objDLG_Attribute_VARCHAR255 = New dlgAttribute_Varchar255(objTreeNode.Text, objLocalConfig_Localize.Globals)
                    objDLG_Attribute_VARCHAR255.ShowDialog(Me)
                    If objDLG_Attribute_VARCHAR255.DialogResult = DialogResult.OK Then
                        GUID_LocalizedName = Guid.NewGuid
                        objDRC_LogState = semprocA_DBWork_Save_Token.GetData(GUID_LocalizedName, objDLG_Attribute_VARCHAR255.Value1, objLocalConfig_Localize.SemItem_Type_Localized_Names.GUID, True).Rows
                        If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                            objDRC_LogState = semprocA_DBWork_Save_TokenRel.GetData(GUID_LocalizedName, New Guid(objTreeNode.Name), objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID, 0).Rows
                            If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                                objDRC_LogState = procA_DBWork_Save_OR_Token.GetData(objSemItem_Related.GUID).Rows
                                If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                                    GUID_ObjectReference = objDRC_LogState(0).Item("GUID_ObjectReference")
                                    objDRC_LogState = semprocA_DBWork_Save_Token_OR.GetData(GUID_LocalizedName, GUID_ObjectReference, objLocalConfig_Localize.SemItem_RelationType_alternative_for.GUID, 0).Rows
                                    If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig_Localize.Globals.LogState_Insert.GUID Then
                                    ...
                                    Else
                                        semprocA_DBWork_Del_TokenRel.GetData(GUID_LocalizedName, New Guid(objTreeNode.Name), objLocalConfig_Localize.SemItem_RelationType_isWrittenIn.GUID)
