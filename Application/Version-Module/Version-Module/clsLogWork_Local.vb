...
Public Class clsLogWork_Local
    ...
    Private objLocalConfig As Version_Module.clsLocalConfig
    ...
    Public Function log_Entry(ByVal objSemItem_Rel As clsSemItem, Optional ByVal objSemItem_State As clsSemItem = Nothing, Optional ByVal change_Version As Boolean = True, Optional ByVal strMessage As String = Nothing) As clsSemItem
        Dim objDate As Date

        Dim objSemItem_Rel_Parent As New clsSemItem
        ...
        boolChangeVersion = change_Version
        ...
        If Not strMessage = Nothing Then
            ...
            If boolWeiter = True Then
                ...
                objDate = Now
                objSemItem_LogEntry = objLogManagement.log_Entry(objDate, objSemItem_State.GUID, objLocalConfig.SemItem_User.GUID, strMessage)

                objDRC_LogState = semprocA_DBWork_Save_TokenRel.GetData(objSemItem_Rel.GUID, objSemItem_LogEntry.GUID, objLocalConfig.SemItem_RelationType_Happened.GUID, 0).Rows
                If objDRC_LogState(0).Item("GUID_Token") = objLocalConfig.Globals.LogState_Insert.GUID Then
                    ...
                    If boolChangeVersion = True Then
                        ...
                        Do
                            objFrm_Version = New frmVersion(objLocalConfig.Globals, objSemItem_Rel, objLocalConfig.SemItem_User, False, objSemItem_LogEntry)
                ...
                If Not objSemItem_Rel.GUID_Related.ToString = objLocalConfig.Globals.GUID_Empty_str Then
                    MsgBox("Log für übergeordnete Item!", MsgBoxStyle.Information)
                    objSemItem_Rel_Parent.GUID = objSemItem_Rel.GUID_Related
                    log_Entry(objSemItem_Rel_Parent, objSemItem_State, True, strMessage & "\" & objSemItem_Rel.Name)
                End If
            Else
                objSemItem_LogEntry = Nothing
