...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token WHERE GUID_Token=''1638cf12-8ad5-4ff5-9d04-71054dd64658'') = 0
	insert into semtbl_Token VALUES(''1638cf12-8ad5-4ff5-9d04-71054dd64658'',''26.01.2013 22:20:24: Erzeugt'',''351d4591-2495-4501-82ab-a425f5235db9'')'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_Attribute WHERE GUID_TokenAttribute=''4d081495-46b7-4fca-b9d1-0772b3480def'' )=0
	INSERT INTO semtbl_Token_Attribute VALUES(''4d081495-46b7-4fca-b9d1-0772b3480def'',''1638cf12-8ad5-4ff5-9d04-71054dd64658'',''2e5fd016-c574-4924-b724-d1b30640243a'')'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_Attribute WHERE GUID_TokenAttribute=''395e0b1b-e56b-41fd-a7eb-cec5005aefbb'' )=0
	INSERT INTO semtbl_Token_Attribute VALUES(''395e0b1b-e56b-41fd-a7eb-cec5005aefbb'',''1638cf12-8ad5-4ff5-9d04-71054dd64658'',''0d2c794d-281d-44ff-9767-eb8549d4ad16'')'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_Attribute_Datetime WHERE GUID_TokenAttribute=''4d081495-46b7-4fca-b9d1-0772b3480def'' )=0
	INSERT INTO semtbl_Token_Attribute_Datetime VALUES(''4d081495-46b7-4fca-b9d1-0772b3480def'',''26.01.2013 22:20:24'',0)'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_Attribute_VarcharMax WHERE GUID_TokenAttribute=''395e0b1b-e56b-41fd-a7eb-cec5005aefbb'' )=0
	INSERT INTO semtbl_Token_Attribute_VarcharMax VALUES(''395e0b1b-e56b-41fd-a7eb-cec5005aefbb'',''Erzeugt'',0)'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_OR WHERE GUID_ObjectReference=''72ce104d-7f59-41a7-bf6c-08198b0017fa'')=0
	INSERT INTO semtbl_OR VALUES(''72ce104d-7f59-41a7-bf6c-08198b0017fa'',''4cef5745-b03c-4d34-9165-b865a7d384b1'')'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_OR_Token WHERE GUID_ObjectReference=''72ce104d-7f59-41a7-bf6c-08198b0017fa'')=0
	INSERT INTO semtbl_OR_Token VALUES(''72ce104d-7f59-41a7-bf6c-08198b0017fa'',''1638cf12-8ad5-4ff5-9d04-71054dd64658'')'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_OR WHERE GUID_Token_Left=''70253592-e2ce-4340-a9e7-36a8a1f4230b'' AND GUID_ObjectReference=''72ce104d-7f59-41a7-bf6c-08198b0017fa'' AND GUID_RelationType=''f68a9438-fb8b-418d-8e0b-d9aefc9ecdf3'')=0
	INSERT INTO semtbl_Token_OR VALUES(''70253592-e2ce-4340-a9e7-36a8a1f4230b'',''72ce104d-7f59-41a7-bf6c-08198b0017fa'',''f68a9438-fb8b-418d-8e0b-d9aefc9ecdf3'',1)'
GO
