...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Attribute WHERE GUID_Attribute=''db6b6294-126c-4fc8-b43e-1e24cf3cb355'') = 0
	insert into semtbl_Attribute VALUES(''db6b6294-126c-4fc8-b43e-1e24cf3cb355'',''Filestreams'',''dd858f27-d5e1-4363-a5c3-3e561e432333'')'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Attribute WHERE GUID_Attribute=''84df515b-9446-4c59-8db1-a2b1d146aab7'') = 0
	insert into semtbl_Attribute VALUES(''84df515b-9446-4c59-8db1-a2b1d146aab7'',''Create Datatypes'',''dd858f27-d5e1-4363-a5c3-3e561e432333'')'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Attribute WHERE GUID_Attribute=''c2fa5e0c-339f-4f69-9363-b21cd4275093'') = 0
	insert into semtbl_Attribute VALUES(''c2fa5e0c-339f-4f69-9363-b21cd4275093'',''Create Object-Reference-Typs'',''dd858f27-d5e1-4363-a5c3-3e561e432333'')'
GO
...
GO
IF (SELECT COUNT(*) FROM semtbl_Type WHERE GUID_Type='801a5333-66ae-4239-b43a-73cf2cd8f3c4') = 0
	insert into semtbl_Type VALUES('801a5333-66ae-4239-b43a-73cf2cd8f3c4','Database-Schema','132a845f-849f-4f6b-8684-7ab3fd068824')
GO
IF (SELECT COUNT(*) FROM semtbl_Type WHERE GUID_Type='6ffcf776-1e4c-4497-afaa-7cff6de69642') = 0
	insert into semtbl_Type VALUES('6ffcf776-1e4c-4497-afaa-7cff6de69642','DBSchema Of Application','801a5333-66ae-4239-b43a-73cf2cd8f3c4')
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token WHERE GUID_Token=''c7362a8c-f804-472f-9003-7e37aeb5d54b'') = 0
	insert into semtbl_Token VALUES(''c7362a8c-f804-472f-9003-7e37aeb5d54b'',''Splunk-Connector-Module (System@h3d-kolltass-01)'',''6ffcf776-1e4c-4497-afaa-7cff6de69642'')'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Type_Attribute WHERE GUID_Type=''801a5333-66ae-4239-b43a-73cf2cd8f3c4'' AND GUID_Attribute=''db6b6294-126c-4fc8-b43e-1e24cf3cb355'')=0
	INSERT INTO semtbl_Type_Attribute VALUES(''801a5333-66ae-4239-b43a-73cf2cd8f3c4'',''db6b6294-126c-4fc8-b43e-1e24cf3cb355'',1,1)'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Type_Attribute WHERE GUID_Type=''801a5333-66ae-4239-b43a-73cf2cd8f3c4'' AND GUID_Attribute=''84df515b-9446-4c59-8db1-a2b1d146aab7'')=0
	INSERT INTO semtbl_Type_Attribute VALUES(''801a5333-66ae-4239-b43a-73cf2cd8f3c4'',''84df515b-9446-4c59-8db1-a2b1d146aab7'',1,1)'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Type_Attribute WHERE GUID_Type=''801a5333-66ae-4239-b43a-73cf2cd8f3c4'' AND GUID_Attribute=''c2fa5e0c-339f-4f69-9363-b21cd4275093'')=0
	INSERT INTO semtbl_Type_Attribute VALUES(''801a5333-66ae-4239-b43a-73cf2cd8f3c4'',''c2fa5e0c-339f-4f69-9363-b21cd4275093'',1,1)'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_OR WHERE GUID_ObjectReference=''21e30b26-b53d-4c30-bd36-cf1347960faa'')=0
	INSERT INTO semtbl_OR VALUES(''21e30b26-b53d-4c30-bd36-cf1347960faa'',''4cef5745-b03c-4d34-9165-b865a7d384b1'')'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_OR_Token WHERE GUID_ObjectReference=''21e30b26-b53d-4c30-bd36-cf1347960faa'')=0
	INSERT INTO semtbl_OR_Token VALUES(''21e30b26-b53d-4c30-bd36-cf1347960faa'',''c7362a8c-f804-472f-9003-7e37aeb5d54b'')'
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_OR WHERE GUID_Token_Left=''70253592-e2ce-4340-a9e7-36a8a1f4230b'' AND GUID_ObjectReference=''ae863148-c4e2-4473-81eb-19f4f95c436c'' AND GUID_RelationType=''81bbd380-e356-48a1-a4b7-fdbaebe7273c'')=0
	INSERT INTO semtbl_Token_OR VALUES(''70253592-e2ce-4340-a9e7-36a8a1f4230b'',''ae863148-c4e2-4473-81eb-19f4f95c436c'',''81bbd380-e356-48a1-a4b7-fdbaebe7273c'',1)'
GO
...
GO
execute dbo.sp_executesql @statement = N'IF (SELECT COUNT(*) FROM semtbl_Token_OR WHERE GUID_Token_Left=''70253592-e2ce-4340-a9e7-36a8a1f4230b'' AND GUID_ObjectReference=''21e30b26-b53d-4c30-bd36-cf1347960faa'' AND GUID_RelationType=''f68a9438-fb8b-418d-8e0b-d9aefc9ecdf3'')=0
	INSERT INTO semtbl_Token_OR VALUES(''70253592-e2ce-4340-a9e7-36a8a1f4230b'',''21e30b26-b53d-4c30-bd36-cf1347960faa'',''f68a9438-fb8b-418d-8e0b-d9aefc9ecdf3'',1)'
GO
