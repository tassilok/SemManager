	...
	FROM 
		  ...
		  INNER JOIN 
				 ...
				 (SELECT GUID_Token_Left, GUID_Token_Right, GUID_RelationType, COUNT(*) AS Count_Changes
				  ...
				  GROUP BY GUID_Token_Left, GUID_Token_Right, GUID_RelationType) TokenToken_With_gt10 ON TokenToken_With_gt10.GUID_RelationType = chngtbll_Token_Token.GUID_RelationType AND TokenToken_With_gt10.GUID_Token_Left = chngtbll_Token_Token.GUID_Token_Left AN
D TokenToken_With_gt10.GUID_Token_Right = chngtbll_Token_Token.GUID_Token_Right
...
GO
EXEC sp_addextendedproperty 
		@name = SchemaVersion, @value = '0.1.0.37';
GO
EXEC sp_addextendedproperty 
