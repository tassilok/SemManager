CREATE DATABASE sem_db_work
GO
use [sem_db_change]
INSERT INTO chngtbl_db VALUES('acba107b-532e-4c9f-9a81-a84589de3445','sem_db_work',0)
GO
use [sem_db_work]
GO
...
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Transaction_Action] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Transaction_Action]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Type_OR]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Type_OR] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Type_OR]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_RelationType]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_RelationType] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_RelationType]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Type_Rel]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Type_Rel] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Type_Rel]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_TokenAttribute]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_TokenAttribute] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_TokenAttribute]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Attribute]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Attribute] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Attribute]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_AttributeType]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_AttributeType] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_AttributeType]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_RelationType]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_RelationType] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_RelationType]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_AttributeType]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_AttributeType] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_AttributeType]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Token_OR]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Token_OR] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Token_OR]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_TypeType]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_TypeType] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_TypeType]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_DB]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_DB] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_DB]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_TokenToken]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_TokenToken] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_TokenToken]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_TypeAttribute]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_TypeAttribute] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_TypeAttribute]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_Token]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_Token] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_Token]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_Type]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_Type] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_Type]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Token_Token]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Token_Token] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Token_Token]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Type]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Type] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Type]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Token_Attribute]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Token_Attribute] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Token_Attribute]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Token]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Token] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Token]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Type_Attribute]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Type_Attribute] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Type_Attribute]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_OR_Attribute]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_OR_Attribute] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_OR_Attribute]'
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngtbl_Transaction]') AND type='SN')
BEGIN
execute dbo.sp_executesql @statement = N'CREATE SYNONYM [dbo].[chngtbl_Transaction] FOR [h3d-kolltass-01\SQLEXPRESS].[sem_db_change].[dbo].[chngtbl_Transaction]'
END
GO
...
BEGIN
    ...
    -- Insert statements for procedure here
      ...
      BEGIN
            ...
            ORDER BY Level, OrderID, Name_Token
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngproc_TokenRel_Move]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'-- =============================================
...
CREATE PROCEDURE [dbo].[chngproc_TokenRel_Move] 
...
BEGIN
	...
	DECLARE @tmp_Change TABLE

	(

		   GUID_DB                uniqueidentifier

		  ,GUID_Transaction		  uniqueidentifier

		  ,GUID_Action            uniqueidentifier
	...
	FROM 
		  ...
		  SELECT	 RANK() OVER(PARTITION BY chngtbll_Token_Token.GUID_RelationType ORDER BY Version DESC) AS ID

					,chngtbll_Token_Token.GUID_DB

					,chngtbll_Token_Token.GUID_Transaction

					,chngtbll_Transaction.GUID_Action

					,chngtbll_Token_Token.GUID_RelationType

					,chngtbll_Token_Token.GUID_Token_Left

					,chngtbll_Token_Token.GUID_Token_Right

					,chngtbll_Token_Token.OrderID

					,chngtbll_Transaction.TransactionDate_Start

					,chngtbll_Token_Token.Version

		  FROM chngtbll_Token_Token

		  INNER JOIN 

				 (SELECT GUID_Token_Left, GUID_Token_Right, GUID_RelationType, COUNT(*) AS Count_Changes

				  FROM chngtbll_Transaction

				  INNER JOIN chngtbll_Token_Token ON chngtbll_Token_Token.GUID_Transaction = chngtbll_Transaction.GUID_Transaction

				  GROUP BY GUID_Token_Left, GUID_Token_Right, GUID_RelationType) TokenToken_With_gt10 ON TokenToken_With_gt10.GUID_RelationType = chngtbll_Token_Token.GUID_RelationType AND TokenToken_With_gt10.GUID_Token_Left = chngtbll_Token_Token.GUID_Token_Left AND TokenToken_With_gt10.GUID_Token_Right = chngtbll_Token_Token.GUID_Token_Right

		  INNER JOIN chngtbll_Transaction ON chngtbll_Transaction.GUID_Transaction = chngtbll_Token_Token.GUID_Transaction

		  ) AS TokenToken_Ranked

	WHERE ID>10



	INSERT INTO chngtbl_Transaction

	SELECT GUID_Transaction, GUID_Action, Transaction_Timestamp

	FROM @tmp_Change



	INSERT INTO chngtbl_Token_Token

	SELECT Version, GUID_Token_Left, GUID_Token_Right, GUID_RelationType, GUID_DB, OrderID, GUID_Transaction

	FROM @tmp_Change



	DELETE FROM chngtbll_Transaction

	WHERE GUID_Transaction IN (SELECT GUID_Transaction FROM @tmp_Change)
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngproc_Type_Move]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'-- =============================================
...
CREATE PROCEDURE chngproc_Type_Move
...
BEGIN
	...
	FROM 
		  ...
		  SELECT	 RANK() OVER(PARTITION BY chngtbll_Type.GUID_Type ORDER BY Version DESC) AS ID

					,chngtbll_Type.GUID_DB

					,chngtbll_Type.GUID_Transaction

					,chngtbll_Transaction.GUID_Action

					,chngtbll_Type.GUID_Type

					,chngtbll_Type.GUID_Type_Parent

					,chngtbll_Transaction.TransactionDate_Start

					,chngtbll_Type.Version
		  ...
		  INNER JOIN 
				 ...
				 (SELECT GUID_Type, COUNT(*) AS Count_Changes

				  FROM chngtbll_Transaction

				  INNER JOIN chngtbll_Type ON chngtbll_Type.GUID_Transaction = chngtbll_Transaction.GUID_Transaction

				  GROUP BY GUID_Type

				  HAVING COUNT(*) > 10) Type_With_gt10 ON Type_With_gt10.GUID_Type = chngtbll_Type.GUID_Type

		  INNER JOIN chngtbll_Transaction ON chngtbll_Transaction.GUID_Transaction = chngtbll_Type.GUID_Transaction
	...
	INSERT INTO chngtbl_Token

	SELECT Version, GUID_Type, GUID_DB, Name, GUID_Type_Parent, GUID_Transaction
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sysproc_Exchange_Attributes]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'
...
CREATE PROCEDURE [dbo].[sysproc_Exchange_Attributes]

	-- Add the parameters for the stored procedure here

	 @GUID_Attribute_new		uniqueidentifier
...
BEGIN
	...
	DECLARE @GUID_Attribute_Old		uniqueidentifier

	DECLARE @GUID_AttributeType		uniqueidentifier

	

	SELECT @GUID_Attribute_Old = GUID_Attribute, @GUID_AttributeType = GUID_AttributeType
	...
	IF @GUID_Attribute_Old <> @GUID_Attribute_new

	BEGIN

		UPDATE semtbl_Attribute

		SET Name_Attribute = @Name_Attribute + ''_old''

		WHERE Name_Attribute = @Name_Attribute

		

		INSERT INTO semtbl_Attribute 

		VALUES (@GUID_Attribute_new, @Name_Attribute, @GUID_AttributeType)

		

		UPDATE semtbl_Type_Attribute

		SET GUID_Attribute=@GUID_Attribute_new

		WHERE GUID_Attribute = @GUID_Attribute_Old

		

		UPDATE semtbl_Token_Attribute
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngproc_Token_Move]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'-- =============================================
...
CREATE PROCEDURE chngproc_Token_Move
...
BEGIN
	...
	FROM 
		  ...
		  SELECT	 RANK() OVER(PARTITION BY chngtbll_Token.GUID_Token ORDER BY Version DESC) AS ID

					,chngtbll_Token.GUID_DB

					,chngtbll_Token.GUID_Transaction

					,chngtbll_Transaction.GUID_Action

					,chngtbll_Token.GUID_Token

					,chngtbll_Token.GUID_Type

					,chngtbll_Transaction.TransactionDate_Start

					,chngtbll_Token.Version
		  ...
		  INNER JOIN 
				 ...
				 (SELECT GUID_Token, COUNT(*) AS Count_Changes

				  FROM chngtbll_Transaction

				  INNER JOIN chngtbll_Token ON chngtbll_Token.GUID_Transaction = chngtbll_Transaction.GUID_Transaction

				  GROUP BY GUID_Token

				  HAVING COUNT(*) > 10) Token_With_gt10 ON Token_With_gt10.GUID_Token = chngtbll_Token.GUID_Token

		  INNER JOIN chngtbll_Transaction ON chngtbll_Transaction.GUID_Transaction = chngtbll_Token.GUID_Transaction
	...
	SELECT Version, GUID_Token, GUID_DB, Name, GUID_Type, GUID_Transaction
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sysproc_Exchange_Type]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'
...
CREATE PROCEDURE [dbo].[sysproc_Exchange_Type]

	-- Add the parameters for the stored procedure here

	 @GUID_Type_New		uniqueidentifier
...
BEGIN
	...
	DECLARE @GUID_Type_Old		uniqueidentifier
	...
	SELECT @GUID_Type_Old = GUID_Type, @GUID_Type_Parent = GUID_Type_Parent
	...
	SET Name_Type=@Name_Type + ''_old''

	WHERE GUID_Type = @GUID_Type_Old





	IF (SELECT COUNT(*) FROM semtbl_Type WHERE GUID_Type = @GUID_Type_New)=0

	BEGIN

		INSERT INTO semtbl_Type VALUES (@GUID_Type_new, @Name_Type, @GUID_Type_Parent)
	...
	SET GUID_Type_Parent = @GUID_Type_New

	WHERE GUID_Type_Parent = @GUID_Type_Old



	UPDATE semtbl_Type_Type

	SET GUID_Type_Left = @GUID_Type_new

	WHERE GUID_Type_Left=@GUID_Type_old



	UPDATE semtbl_Type_Type

	SET GUID_Type_Right = @GUID_Type_new

	WHERE GUID_Type_Right=@GUID_Type_old



	UPDATE semtbl_Type_Attribute

	SET GUID_Type = @GUID_Type_New

	WHERE GUID_Type = @GUID_Type_Old



	UPDATE semtbl_Or_Type
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngproc_RelationType_Move]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'-- =============================================
...
CREATE PROCEDURE chngproc_RelationType_Move
...
BEGIN
	...
	FROM 
		  ...
		  SELECT	 RANK() OVER(PARTITION BY chngtbll_RelationType.GUID_RelationType ORDER BY Version DESC) AS ID

					,chngtbll_RelationType.GUID_DB

					,chngtbll_RelationType.GUID_Transaction

					,chngtbll_Transaction.GUID_Action

					,chngtbll_RelationType.GUID_RelationType

					,chngtbll_Transaction.TransactionDate_Start

					,chngtbll_RelationType.Version

					,chngtbll_RelationType.Name

		  FROM chngtbll_RelationType

		  INNER JOIN 

				 (SELECT GUID_RelationType, COUNT(*) AS Count_Changes

				  FROM chngtbll_Transaction

				  INNER JOIN chngtbll_RelationType ON chngtbll_RelationType.GUID_Transaction = chngtbll_Transaction.GUID_Transaction

				  GROUP BY GUID_RelationType

				  HAVING COUNT(*) > 10) RelationType_With_gt10 ON RelationType_With_gt10.GUID_RelationType = chngtbll_RelationType.GUID_RelationType

		  INNER JOIN chngtbll_Transaction ON chngtbll_Transaction.GUID_Transaction = chngtbll_RelationType.GUID_Transaction

		  ) AS RelationType_Ranked
	...
	INSERT INTO chngtbl_RelationType

	SELECT Version, GUID_RelationType, GUID_DB, Name, GUID_Transaction
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[chngproc_Attribute_Move]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'-- =============================================
...
CREATE PROCEDURE chngproc_Attribute_Move 
...
BEGIN
	...
	FROM 
		  ...
		  SELECT	 RANK() OVER(PARTITION BY chngtbll_Attribute.GUID_Attribute ORDER BY Version DESC) AS ID

					,chngtbll_Attribute.GUID_DB

					,chngtbll_Attribute.GUID_Transaction

					,chngtbll_Transaction.GUID_Action

					,chngtbll_Attribute.GUID_Attribute

					,chngtbll_Attribute.GUID_AttributeType

					,chngtbll_Transaction.TransactionDate_Start

					,chngtbll_Attribute.Version

					,chngtbll_Attribute.Name

		  FROM chngtbll_Attribute

		  INNER JOIN 

				 (SELECT GUID_Attribute, COUNT(*) AS Count_Changes

				  FROM chngtbll_Transaction

				  INNER JOIN chngtbll_Attribute ON chngtbll_Attribute.GUID_Transaction = chngtbll_Transaction.GUID_Transaction

				  GROUP BY GUID_Attribute

				  HAVING COUNT(*) > 10) Attribute_With_gt10 ON Attribute_With_gt10.GUID_Attribute = chngtbll_Attribute.GUID_Attribute

		  INNER JOIN chngtbll_Transaction ON chngtbll_Transaction.GUID_Transaction = chngtbll_Attribute.GUID_Transaction
	...
	INSERT INTO chngtbl_Attribute

	SELECT Version, GUID_Attribute, GUID_DB, Name, GUID_AttributeType, GUID_Transaction
...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[sysproc_Exchange_RelationTypes]') AND type in (N'P', N'PC'))
BEGIN
execute dbo.sp_executesql @statement = N'
...
CREATE PROCEDURE [dbo].[sysproc_Exchange_RelationTypes]

	-- Add the parameters for the stored procedure here

	 @GUID_RelationType_new		uniqueidentifier
...
BEGIN
	...
	DECLARE @GUID_RelationType_Old		uniqueidentifier

	

	SELECT @GUID_RelationType_Old = GUID_RelationType
	...
	IF @GUID_RelationType_Old <> @GUID_RelationType_new

	BEGIN

		UPDATE semtbl_RelationType

		SET Name_RelationType = @Name_RelationType + ''_old''

		WHERE Name_RelationType = @Name_RelationType

		

		INSERT INTO semtbl_RelationType 

		VALUES (@GUID_RelationType_new, @Name_RelationType)

		

		UPDATE semtbl_Type_Type

		SET GUID_RelationType=@GUID_RelationType_new

		WHERE GUID_RelationType = @GUID_RelationType_Old

		

		UPDATE semtbl_Token_Token
...
END
GO
INSERT INTO chngtbll_db VALUES('acba107b-532e-4c9f-9a81-a84589de3445','sem_db_work')
GO
...
GO
EXEC sp_addextendedproperty 
		@name = SchemaVersion, @value = '0.1.0.39';
GO
EXEC sp_addextendedproperty 
